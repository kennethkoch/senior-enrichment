...
const rootReducer = function(prevState = initialState, action) {
  switch (action.type) {
    ...
    case NEW_CAMPUS_IMAGE:
      return Object.assign({}, prevState, {
        newCampusEntry: {
          name: prevState.newCampusEntry.name,
    ...
    case NEW_CAMPUS_ENTRY:
      return Object.assign({}, prevState, {
        campuses: prevState.campuses.concat(action.newCampusEntry)
      })
    case NEW_STUDENT_FIRST_NAME:
      return Object.assign({}, prevState, {
        newStudentEntry: {
          firstName: action.newStudentFirstName,
    ...
    case NEW_STUDENT_LAST_NAME:
      return Object.assign({}, prevState, {
        newStudentEntry: {
          firstName: prevState.newStudentEntry.firstName,
    ...
    case NEW_STUDENT_ENTRY:
      return Object.assign({}, prevState, {
        students: prevState.students.concat(action.newStudentEntry)
      })
    case UPDATE_STUDENT:
      return Object.assign({}, prevState, {
        students: prevState.students.concat(action.newStudentEntry)
