...
export const gotCampuses = function(campuses) {
  return {type: GOT_CAMPUSES, campuses: campuses}
}

export const gotStudents = function(students) {
  return {type: GOT_STUDENTS, students: students}
}

export const gotSingleCampus = function(currentCampus) {
  return {type: GOT_SINGLE_CAMPUS, currentCampus: currentCampus}
}

export const gotSingleStudent = function(currentStudent) {
  return {type: GOT_SINGLE_STUDENT, currentStudent: currentStudent}
}

//add a new campus to database
export const addCampusName = function(newCampusName) {
  return {type: NEW_CAMPUS_NAME, newCampusName: newCampusName}
}

export const addCampusImage = function(newCampusImage) {
  return {type: NEW_CAMPUS_IMAGE, newCampusImage: newCampusImage}
}

export const addCampusDescription = function(newCampusDescription) {
  return {type: NEW_CAMPUS_DESCRIPTION, newCampusDescription: newCampusDescription}
}

export const newCampusEntry = function(newCampusEntry) {
  return {type: NEW_CAMPUS_ENTRY, newCampusEntry: newCampusEntry}
}

//Add a new student to database
export const addStudentFirstName = function(newStudentFirstName) {
  return {type: NEW_STUDENT_FIRST_NAME, newStudentFirstName: newStudentFirstName}
}

export const addStudentLastName = function(newStudentLastName) {
  return {type: NEW_STUDENT_LAST_NAME, newStudentLastName: newStudentLastName}
}

export const addStudentEmail = function(newStudentEmail) {
  return {type: NEW_STUDENT_EMAIL, newStudentEmail: newStudentEmail}
}

export const addStudentGpa = function(newStudentGpa) {
  return {type: NEW_STUDENT_GPA, newStudentGpa: newStudentGpa}
}

export const addStudentCampus = function(campusId) {
  return {type: NEW_STUDENT_CAMPUS, campusId: campusId}
}

export const newStudentEntry = function(newStudentEntry) {
  return {type: NEW_STUDENT_ENTRY, newStudentEntry: newStudentEntry}
}
...
export function fetchSingleCampus(campusId) {
  return function thunk(dispatch) {
    axios.get(`/api/campuses/${campusId}`).then(res => res.data).then((campus) => {
...
export function updateStudent(studentId, update) {
  return function thunk(dispatch) {
    axios.put(`/api/students/${studentId}`, update).then((student) => {
      dispatch(fetchStudents())
    })
  }
}
...
export function updateCampus(campusId, update) {
  return function thunk(dispatch) {
    axios.put(`/api/campuses/${campusId}`, update).then((campus) => {
      dispatch(fetchCampuses())
    })
  }
}
